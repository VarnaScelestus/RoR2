    ...
    public class BepConfig
    {
        ...
        public static void Init()
        {
            ...
            ModSettingsManager.SetModDescription(
                ...
                + "\n\n<style=cSub>"
                + (EnableArtifact.Value? "< ! > <color=#adf2fa>Artifact of the New Moon</color> is enabled. " : "")
                + (StartingCoins.Value > 0 && EnableArtifact.Value? " Start with " + StartingCoins.Value + " coin(s).\n" : "")
